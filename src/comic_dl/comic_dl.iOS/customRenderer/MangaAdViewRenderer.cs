...
[assembly: ExportRenderer(typeof(comic_dl.Controls.MangaDetailAdViewControl), typeof(comic_dl.iOS.customRenderer.MangaAdViewRenderer))]
    ...
    public class MangaAdViewRenderer : ViewRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.View> e)
        {
            ...
            if (e.OldElement == null)
            {
                ...
                {
                    AdUnitID = "ca-app-pub-8359860011604747/8984707227",
